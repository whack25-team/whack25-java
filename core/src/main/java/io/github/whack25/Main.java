...
public class Main extends ApplicationAdapter {
    ...
    public void create() {
        ...
        */
        ...
        houseTexture = new Texture("groundtile.png");
        roadTexture = new Texture("roadtile.png"); // TODO
        roadTopTexture = new Texture("roadtile.png");
        roadDownTexture = new Texture("roadtile.png");
        roadRightTexture = new Texture("roadtile.png");
        roadLeftTexture = new Texture("roadtile.png");
        grassTexture = new Texture("roadtile.png");
        carTexture = new Texture("drop.png");
